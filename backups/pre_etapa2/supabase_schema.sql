...
-- 2. TABLA: categorias
-- Contiene las 10 ramas, grupos y subcategorías de la cadena productiva
...
COMMENT ON TABLE public.categorias IS 'Subcategorías de la cadena de la construcción en Carabobo con sus tipos de actor';
COMMENT ON COLUMN public.categorias.slug IS 'Identificador legible y único (ej: aridos-grava-arena)';
